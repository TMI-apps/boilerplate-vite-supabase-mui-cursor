...
- **Git workflow mode:** Read `src/config/git-workflow.json`, then apply `.cursor/rules/git-workflow/RULE.md` § Mode-aware branch gate (Model A default / Model B opt-in).
