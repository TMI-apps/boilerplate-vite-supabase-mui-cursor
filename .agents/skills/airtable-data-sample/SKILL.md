...
Run `**.agents/skills/airtable-schema-structure/SKILL.md**` first: full field list (names, `fld…`, types) for the table, mapped to what the app uses. This skill only makes sense once you know which `fld…` values to pass to `--fields`.
...
| What fields exist / types / links? | `.agents/skills/airtable-schema-structure/SKILL.md` |
