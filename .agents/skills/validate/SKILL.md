...
**Related:** Plan with `.agents/skills/plan/SKILL.md`. Execute with `.agents/skills/implement/SKILL.md`. Pre-merge architecture gate: `.agents/skills/check/SKILL.md` (same fan-out, smaller default rule set, no plan-compliance pass). Small scoped PIV in one go: `.agents/skills/quick-piv/SKILL.md`. Session context: `.agents/skills/prime/SKILL.md`. Commits and changelog: `.agents/skills/finish/SKILL.md`.
