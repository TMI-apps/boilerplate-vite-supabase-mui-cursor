...
| What do cell values look like (shape, attachments, rich text)? | `.agents/skills/airtable-data-sample/SKILL.md` |
...
- `.agents/skills/airtable-data-sample/SKILL.md` — sample rows after schema is known
