...
**Edge Functions have unique testing constraints** (branch model SSOT: `.cursor/rules/git-workflow/RULE.md` § Mode-aware branch gate; mode: `src/config/git-workflow.json`):
