...
**Reference:** See `.agents/skills/optimize2/SKILL.md` for detailed refactoring workflow and examples.
...
- `.agents/skills/optimize2/SKILL.md` - Detailed complexity reduction / optimization workflow
