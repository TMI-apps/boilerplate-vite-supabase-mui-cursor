...
**Branch model (general):** `.cursor/rules/git-workflow/RULE.md` § Mode-aware branch gate (`src/config/git-workflow.json`). **This section** is Edge Function deploy semantics only.
