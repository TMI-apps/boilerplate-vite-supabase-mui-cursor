...
| Concrete behavior, APIs, data, acceptance examples | Follow **Refine** in `.cursor/skills/plan/SKILL.md` (questions and tables there — stop before **Investigate** until gates pass); frame questions around the user's intended app usage when product meaning is unclear |
| You lack repo grounding while clarifying | `.cursor/skills/prime/SKILL.md` **before or mixed with** clarification |
...
| Execute an existing `DEVELOPMENT_PLAN.md` phase by phase | `.cursor/skills/implement/SKILL.md` |
| Small scoped change; plan+implement+validate in one pass | `.cursor/skills/quick-piv/SKILL.md` |
| Review plan or implementation **without** editing by default | `.cursor/skills/validate/SKILL.md` |
| Pre-merge / post-refactor architecture & quality gate (layer semantics + tooling) | `.cursor/skills/check/SKILL.md` |
...
| Situation | Skill |
|-----------|--------|
| Full feature request with mandatory decision stops and phased spec | `.cursor/skills/feature/SKILL.md` |
| Scientific debugging; hypotheses; user supplies runtime evidence | `.cursor/skills/debug/SKILL.md` |
| Stress-test product/design choices before implementation | `.agents/skills/grill-me/SKILL.md` |
| Simplify **one** concrete feature (flows + code), reduce steps/complexity | `.cursor/skills/challenge/SKILL.md` |
| Find cross-feature duplication and consolidation candidates | `.cursor/skills/consolidate/SKILL.md` |
| Optimize hotspots: design → approach → efficiency → complexity | `.cursor/skills/optimize2/SKILL.md` |
| Semantic architecture repair **after** automated checks pass | `.cursor/skills/architecture-repair2/SKILL.md` |
| Retro from failures/diffs; persist lessons into rules or skills | `.cursor/skills/learn/SKILL.md` |
| Tighten prose/structure of an appended rule draft | `.cursor/skills/improve-rule/SKILL.md` |
| Score quality of an attached rule/command with rubric | `.cursor/skills/grade-rule/SKILL.md` |
| Brief reflection: problem, attempts, wider alternative | `.cursor/skills/stepback/SKILL.md` *(minimal)* |

### This repo — integrations

| Situation | Skill |
|-----------|--------|
| Airtable Meta/schema (`tbl…` / `fld…`), no row payloads | `.cursor/skills/airtable-schema-structure/SKILL.md` |
| Sample Airtable rows / cell shapes **after** schema known | `.cursor/skills/airtable-data-sample/SKILL.md` |
...
- `.cursor/skills/check/SKILL.md`
- `.cursor/skills/consolidate/SKILL.md`
- `.cursor/skills/review/SKILL.md`
- `.cursor/skills/finish/SKILL.md`
- `.cursor/skills/push/SKILL.md`
- `.cursor/skills/quick-piv/SKILL.md`
- `.cursor/skills/prime/SKILL.md`
- `.cursor/skills/start/SKILL.md`
- `.cursor/skills/complete-setup/SKILL.md`
- `.cursor/skills/learn/SKILL.md`
- `.cursor/skills/challenge/SKILL.md`
- `.cursor/skills/feature/SKILL.md`
- `.cursor/skills/debug/SKILL.md`
- `.cursor/skills/grade-rule/SKILL.md`
- `.cursor/skills/improve-rule/SKILL.md`
- `.cursor/skills/architecture-repair2/SKILL.md`
- `.cursor/skills/optimize2/SKILL.md`
- `.cursor/skills/stepback/SKILL.md`
- `.cursor/skills/airtable-schema-structure/SKILL.md`
- `.cursor/skills/airtable-data-sample/SKILL.md`
